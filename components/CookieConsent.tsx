...
export default function CookieConsent() {
  ...
  useEffect(() => {
    const saved = localStorage.getItem("educanology-cookie-consent");
    ...
    try {
      ...
      window.dispatchEvent(
        new CustomEvent("educanology-cookie-consent-updated", { detail: parsed })
      );
    } catch {
      setVisible(true);
    }
  ...
  function savePreferences(nextPreferences: CookiePreferences) {
    localStorage.setItem("educanology-cookie-consent", JSON.stringify(nextPreferences));
    window.dispatchEvent(
      new CustomEvent("educanology-cookie-consent-updated", { detail: nextPreferences })
    );
