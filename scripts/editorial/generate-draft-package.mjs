...
function createBlogDraft(proposal) {
  ...
  const practicalSection = humanFirst
    ? [
    ...
    : [
        "## Quadro prático de implementação",
        "",
        "A proposta deve ser traduzida em decisões operacionais: objetivo, público, responsáveis, recursos, calendário, indicadores, riscos e mecanismo de revisão.",
        "",
        "## Recomendações operacionais",
        "",
        "- Definir o problema público ou educativo antes de escolher instrumentos.",
        "- Mapear recursos existentes e lacunas reais.",
        "- Escolher pilotos pequenos, observáveis e ajustáveis.",
        "- Criar responsabilidades claras de coordenação e revisão.",
        "- Recolher evidência simples antes de escalar.",
      ];
